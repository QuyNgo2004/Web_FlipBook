...
(function($) {
	...
	zoomMethods = {
	  ...
	  zoomIn: function(event) {
		...
		//   alert(this.width())
		//   alert(Math.abs(bound.size.width*zoom-this.width()))
		...
		//alert(center.x*zoom - center.x - flipPos.x - move.x)
		var css = {};
	  ...
	  scroll: function(to, unlimited, animate) {
		...
		if (!unlimited) {
		  ...
		  var out,
			...
			// alert(flipWidth-this.width() + "-1-")
			// alert((flipWidth-this.width())/2 + "-22-")
		  if (to.y<minBound.y) {
